...
{ 
	...
	{ 
		...
		rsc.prepare_image("mybull","mybull",0.5*get_scene_width(), 0.5*get_scene_height()); 
		image1 = add_sprite_for_image(SEImage.for_resource("mybull")); 
		image1.move(0,0); 
		
		rsc.prepare_image("myhawk","myhawk",get_scene_width()*0.5, get_scene_height()*0.5); 
		image2 = add_sprite_for_image(SEImage.for_resource("myhawk")); 
		image2.move(get_scene_width()*0.5,0); 

		rsc.prepare_image("myrocket","myrocket",get_scene_width()*0.5, get_scene_height()*0.5); 
		image3 = add_sprite_for_image(SEImage.for_resource("myrocket")); 
		image3.move(0, get_scene_height()*0.5); 

		rsc.prepare_image("mysuperman","mysuperman",get_scene_width()*0.5, get_scene_height()*0.5); 
		image4 = add_sprite_for_image(SEImage.for_resource("mysuperman")); 
