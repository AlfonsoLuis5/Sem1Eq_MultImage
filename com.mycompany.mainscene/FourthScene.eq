...
{ 
	...
	{ 
		...
		rsc.prepare_image("rocket","rocket",get_scene_width(), get_scene_height()); 
		
		image = add_sprite_for_image(SEImage.for_resource("rocket")); 
		rsc.prepare_font("myfont","arial bold color=blue", 40); text1 = add_sprite_for_text("M", "myfont"); 
